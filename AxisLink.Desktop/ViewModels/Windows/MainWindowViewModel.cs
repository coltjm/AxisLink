...
namespace AxisLink.Desktop.ViewModels.Windows
{
    public partial class MainWindowViewModel : ViewModelBase
    {
        ...
        // DI Constructor
        public MainWindowViewModel(WorkspaceViewModel workspace, IConsoleLogger logger, ShowFileManager fileManager, WindowManager _windowManager, FileDialogService _fileDialogService)
        {
            Workspace = workspace;
            Logger = logger;
        ...
        {
            Workspace = new WorkspaceViewModel(new KQLogger(), new ShowFileManager());
            Logger = new KQLogger();
        }
