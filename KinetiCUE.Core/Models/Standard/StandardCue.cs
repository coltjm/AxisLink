...
namespace KinetiCUE.Core.Models.Standard
{
    ...
    public enum CueObjectStartType
    {
    ...
    public enum CueObjectTargetType
    {
        // Reference to limit stored in scenery object
        [XmlEnum("limit")] Limit,
        // Reference to trim stored in scenery object
    ...
    public class CueObject
    {
        ...
        public CueObjectMoveType? MoveType { get; set; }

        [XmlElement("b_start")]
        public CueObjectStart? Start { get; set; }
        
        // Required if move type is linear or multitarget
        [XmlElement("b_target")]
        public CueObjectTarget? Target { get; set; }
    }

    public class CueObjectStart
    {
        [XmlElement("b_type")]
        public CueObjectStartType? Type { get; set; }
    ...
    public class CueObjectTarget
    {
        [XmlElement("b_type")]
        public CueObjectTargetType? Type { get; set; }
    ...
    public class StandardCue
    {
        ...
        [XmlElement("b_object")]
        public List<CueObject> CueObjects { get; set; } = new();
