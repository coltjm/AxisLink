...
namespace KinetiCUE.Infrastructure.Loggers
{
    public class KQLogger : IKQLogger
    {
        ...
        public KQLogger()
        {
            ...
            string logDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "KinetiCUE", "logs");
            Directory.CreateDirectory(logDir);
            string logPath = Path.Combine(logDir, "KinetiCUE.log");
